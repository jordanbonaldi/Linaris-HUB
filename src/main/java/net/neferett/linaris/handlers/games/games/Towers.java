...
import net.neferett.linaris.handlers.games.games.TowersKit.Kit1;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit2;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit3;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit4;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit5;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit6;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit7;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit8;
import net.neferett.linaris.handlers.games.games.TowersKit.Kit9;
