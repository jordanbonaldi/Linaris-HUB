package net.neferett.linaris.lobby.games.games.rushs;
...
public class KitArcher extends ShopItem {
	...
	public KitArcher() {
		...
		LevelInfo level5 = new LevelInfo(Arrays.asList("§7Obtenez en début de partie :", "", "§7- 1 Plastron en fer", "§7- 1 Arc INFINITY POWER 2 K2 FIRE 1","§7- 1 fleche", "§7- 1 épée en fer"),4000);
